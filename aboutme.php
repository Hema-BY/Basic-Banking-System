...
<body>
	...
	<ul >
			...
			<div id="main">
				<!--div id="main2"></div-->
				<h2> HEMA BY</h2>
				    <!--img id="image2" src="C:\xampp\htdocs\spark\Basic-Banking-System-The-Spark-Foundation-main\img.jpg" align="left"-->

			    <p> I'm pursuing my 3rd year Engineering in Jyothy Institute of Technology,
					I'm intrested in Full stack web development and would like to work on projects related to Web.
					My skills are C,C++,Python,sql,html,css,js .
